...
5. ~~**Mécanique exacte du temps réel**~~ → **Résolu** (`feat/016-realtime-updates`) : Server-Sent Events, pas WebSocket — le site public n'a besoin que de recevoir des mises à jour, jamais d'en envoyer. Détails et justification dans `docs/architecture/realtime-strategy.md`.
