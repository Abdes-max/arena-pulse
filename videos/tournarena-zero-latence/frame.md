...
colors:
  # Hand-corrected after build-frame's automatic remix (see git history):
  # the colorStats heuristic picked the site's dominant LIGHT-mode marketing
  # colors (white canvas, #1E293B text, cyan-on-white accent) since those
  # outnumber the hero's own dark treatment by page area. This project's
  # BRIEF.md explicitly calls for TournArena's "Ink & Signal" DARK-mode
  # tokens instead (matching the already-shipped launch poster in
  # docs/marketing/launch/ and libs/design-tokens/_ink-signal.scss's own
  # [data-mode='dark'] block) -- these are those exact hex values, not a
  # capture artifact.
  ink-black: "#0B1220"
  ink-black-alt: "#141B2E"
  fire-orange: "#38BDF8"
  cream: "#E7ECF5"
  cream-muted: "#94A3B8"
  cream-hint: "#64748B"
  border-dark: "#1F2A44"
  ink-on-orange-muted: "rgba(11,18,32,0.75)"
  ink-on-orange-hint: "rgba(11,18,32,0.55)"
  ink-on-orange-faint: "rgba(11,18,32,0.40)"
  ink-on-orange-border: "rgba(11,18,32,0.20)"
...
typography:
  ...
  stat-value:{ fontFamily: "Barlow", cqw: 5.5, weight: 700, lineHeight: 1.0, tracking: "-0.04em" }
  h1:      { fontFamily: "Barlow", cqw: 7.5, weight: 700, lineHeight: 0.9, tracking: "-0.03em", lower: true }
  fadelist-item:{ fontFamily: "Barlow", cqw: 7.5, weight: 700, lineHeight: 1.0, tracking: "-0.03em", lower: true }
  quote-mark:{ fontFamily: "Barlow", cqw: 10.0, weight: 700, lineHeight: 0.6 }
  fadelist-title:{ fontFamily: "Barlow", cqw: 10.5, weight: 700, lineHeight: 0.9, tracking: "-0.04em", lower: true }
  display: { fontFamily: "Barlow", cqw: 13.0, weight: 700, lineHeight: 0.88, tracking: "-0.04em", lower: true }
...
- **Fonts** — already set to **Barlow** (display) / **Barlow Condensed** (body); ignore any preset font name lingering in prose.
